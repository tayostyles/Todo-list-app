...
window = Tk()
# giving a title
window.title("Tayo Styles' To-Do List App")
...
cur.execute("CREATE TABLE todo_database (added_task VARCHAR PRIMARY KEY, deleted_task VARCHAR, completed_task VARCHAR);")
